/*
    Rootkit source: https://h0mbre.github.io/Learn-C-By-Creating-A-Rootkit/#
    Compilation: gcc rootkit.c -fPIC -shared -D_GNU_SOURCE -o libc.man.so.6 -ldl
*/
